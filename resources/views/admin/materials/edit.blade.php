<x-app-layout>
    ...
    <div class="p-7">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Materiales de {{ $material->subject->subject_name }}</h1>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 mb-8">
            ...
            <form action="{{ route('materials.update', $material) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <x-input class="w-full" name="name" value="{{ old('name', $material->material_name) }}"
                        required />
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="w-full border-gray-300 p-2 rounded focus:ring focus:ring-blue-200">{{ old('description', $material->material_description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div id="editor">{!! old('body', $material->body) !!}</div>
                ...
                <div class="mb-4">
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="active" value="1" class="sr-only peer"
                            @checked($material->active ? true : false)>
                        <div
    ...
    @push('js')
        ...
        <script>
            ...
            // ✅ Poblar textarea con el contenido inicial
